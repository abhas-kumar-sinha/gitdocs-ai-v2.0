...
const TemplatePage = () => {
  ...
  return (
    <div className="w-full px-4 md:px-13 py-10">
      {/* Header & Controls */}
      <h2 className="text-xl font-semibold px-1 mb-2 invisible md:visible">
        Templates
      </h2>
      <p className="mb-12 ms-1 text-foreground/70">
        Templates are pre-built project configurations that you can use to
        create new projects.
      </p>
