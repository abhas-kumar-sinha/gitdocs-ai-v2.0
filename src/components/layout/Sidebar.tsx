...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile View */}
      <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 py-4 px-3 md:hidden flex items-center justify-between backdrop-blur-md">
        <Button
        ...
        <Link
          prefetch={true}
          href="/"
          className="flex items-center space-x-2 flex-1 ms-4"
        >
        ...
        <div className="flex items-center gap-x-2">
          <div className="ms-auto w-fit mt-1">
            <DropdownMenu>
              ...
              <DropdownMenuContent
                side="bottom"
                className="h-128 w-screen flex flex-col"
                align="center"
              >
      ...
      >
          ...
          <div className="shrink-0 w-10 flex items-center justify-center">
            <Image
              ...
              className={cn(
                ...
                isSidebarOpen ? "" : "group-hover/sidebar:hidden -ms-1",
              )}
            />
            <Button
              variant="sidebarButton"
              ...
              className={cn(
                "group/button hidden",
                isSidebarOpen ? "" : "group-hover/sidebar:block -ms-1",
              )}
            >
              <PanelRight className="transition-transform duration-300 group-hover/button:scale-110" />
            </Button>
        ...
        <span
          className={cn(
            "capitalize text-foreground/50 text-xs mt-6 mb-2 ms-2 invisible",
        ...
        <div
          className={cn(
            "w-full flex-col gap-y-2 md:-mb-8 mt-auto invisible",
            isSidebarOpen && "flex visible",
          )}
        >
          {isLoaded && (
            <Dialog
        ...
        <div
          onClick={(e) => e.stopPropagation()}
          className={cn(
            "shrink-0 relative z-10 w-10 md:flex items-center justify-center transition-all duration-300 -ms-0.5 hidden",
            isSidebarOpen && "translate-y-11",
          )}
        >
          <Button
            variant="sidebarButton"
